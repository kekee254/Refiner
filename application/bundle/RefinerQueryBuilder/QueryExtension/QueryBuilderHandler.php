...
use RefinerQueryBuilder\Exception;
...
class QueryBuilderHandler
{
   ...
   * Get first row
   * @return mixed|null
   * @throws \RefinerQueryBuilder\Exception
   */
  ...
  protected function aggregate($type)
    ...
    public function getQuery($type = 'select', $dataToBePassed = array())
    {
        ...
        return $this->pack->build(
            '\\RefinerQueryBuilder\\RefinerQueryBuilder\\QueryObject',
  ...
  public function insert($data)
    ...
    {
        return $this->pack->build('\\RefinerQueryBuilder\\RefinerQueryBuilder\\Raw', array($value, $bindings));
    }
